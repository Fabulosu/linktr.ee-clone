    ...
    return (
        <div className="h-[83.5vh] w-full flex justify-center">
            <form onSubmit={onSubmit} className="pt-60 md:pt-60 flex items-center text-primary flex-col w-full md:w-1/2">
                ...
                <p className="pt-3 text-muted-foreground">You don't have an account? <a href="login" className="transition-all ease-linear duration-200 text-primary hover:text-muted-foreground">Sign up</a></p>
